...
def func1(s1,s2,s3):
    ...
    inp = pd.DataFrame([[s1,s2,s3]],columns=['customer_age','price','gender'])
    #importing csv files
    ...
    inp.replace(cleanup_nums, inplace=True)
    ...
    df1 = pd.DataFrame(y_out)
    df1 = df1.replace({11: "vans", 12: "puma", 13: "calvin-klein", 14: "woodland", 15: "reebok", 16: "nike", 17: "converse", 18: "asics", 19: "skechers", 20: "lotto"})
    arr = df1.values.tolist()
    return arr[0]
